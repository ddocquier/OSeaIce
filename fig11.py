...
if siconc_threshold == 0.:
    if lat_threshold == 80.:
        filename = dir_output + 'vfxice_siconc0_lat80.npy'
    else:
        filename = dir_output + 'vfxice_siconc0.npy'
elif siconc_threshold == 15.:
    filename = dir_output + 'vfxice_siconc15.npy'
elif siconc_threshold == 30.:
    filename = dir_output + 'vfxice_siconc30.npy'
...
if siconc_threshold == 0.:
    if lat_threshold == 80.:
        filename = dir_output + 'vfxbog_siconc0_lat80.npy'
    else:
        filename = dir_output + 'vfxbog_siconc0.npy'
elif siconc_threshold == 15.:
    filename = dir_output + 'vfxbog_siconc15.npy'
elif siconc_threshold == 30.:
    filename = dir_output + 'vfxbog_siconc30.npy'
...
if siconc_threshold == 0.:
    if lat_threshold == 80.:
        filename = dir_output + 'vfxopw_siconc0_lat80.npy'
    else:
        filename = dir_output + 'vfxopw_siconc0.npy'
elif siconc_threshold == 15.:
     filename = dir_output + 'vfxopw_siconc15.npy'
elif siconc_threshold == 30.:
     filename = dir_output + 'vfxopw_siconc30.npy'
...
if siconc_threshold == 0.:
    if lat_threshold == 80.:
        filename = dir_output + 'vfxdyn_siconc0_lat80.npy'
    else:
        filename = dir_output + 'vfxdyn_siconc0.npy'    
elif siconc_threshold == 15.:
    filename = dir_output + 'vfxdyn_siconc15.npy'
elif siconc_threshold == 30.:
    filename = dir_output + 'vfxdyn_siconc30.npy'
...
if siconc_threshold == 0.:
    if lat_threshold == 80.:
        filename = dir_output + 'vfxsni_siconc0_lat80.npy'
    else:
        filename = dir_output + 'vfxsni_siconc0.npy'
elif siconc_threshold == 15.:
    filename = dir_output + 'vfxsni_siconc15.npy'
elif siconc_threshold == 30.:
    filename = dir_output + 'vfxsni_siconc30.npy'
...
if siconc_threshold == 0.:
    if lat_threshold == 80.:
        filename = dir_output + 'vfxbom_siconc0_lat80.npy'
    else:
        filename = dir_output + 'vfxbom_siconc0.npy'
elif siconc_threshold == 15.:
    filename = dir_output + 'vfxbom_siconc15.npy'
elif siconc_threshold == 30.:
    filename = dir_output + 'vfxbom_siconc30.npy'
...
if siconc_threshold == 0.:
    if lat_threshold == 80.:
        filename = dir_output + 'vfxsum_siconc0_lat80.npy'
    else:
        filename = dir_output + 'vfxsum_siconc0.npy'
elif siconc_threshold == 15.:
    filename = dir_output + 'vfxsum_siconc15.npy'
elif siconc_threshold == 30.:
    filename = dir_output + 'vfxsum_siconc30.npy'
...
if save_fig == True:
    if siconc_threshold == 0.:
        ...
        fig.savefig(dir_output+'melt_terms_siconc30.png')
